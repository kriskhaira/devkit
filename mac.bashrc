...
alias mamp.log='multitail -i /Applications/MAMP/logs/apache_error.log -i /Applications/MAMP/logs/mysql_error_log.err -i /Applications/MAMP/logs/php_error.log'
