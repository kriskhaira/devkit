...
alias showpub='cat ~/.ssh/id_rsa.pub'
alias copypub='cat ~/.ssh/id_rsa.pub | pbcopy'
alias pastepub='mkdir ~/.ssh; chmod 700 ~/.ssh; cd ~/.ssh; touch authorized_keys; chmod 600 authorized_keys; vi authorized_keys'
